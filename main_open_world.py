...
def get_args_parser():
    ...
    ## OWOD
    parser.add_argument('--PREV_INTRODUCED_CLS', type=int)
    parser.add_argument('--CUR_INTRODUCED_CLS', type=int)
    ...
    parser.add_argument('--NC_branch', default=True, action='store_true')
    ...
    parser.add_argument('--data_root', default='OWDETR', type=str)
