...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 1 \
    --PREV_INTRODUCED_CLS 19 --CUR_INTRODUCED_CLS 21 --train_set 't2_train' --test_set 'test' --num_classes 81 \
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 1 \
    --PREV_INTRODUCED_CLS 19 --CUR_INTRODUCED_CLS 21 --train_set 't2_ft' --test_set 'test' --num_classes 81 \
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 1 \
    --PREV_INTRODUCED_CLS 40 --CUR_INTRODUCED_CLS 20 --train_set 't3_train' --test_set 'test' --num_classes 81 \
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 1 \
    --PREV_INTRODUCED_CLS 60 --CUR_INTRODUCED_CLS 20 --train_set 't4_train' --test_set 'test' --num_classes 81 \
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 1 \
    --PREV_INTRODUCED_CLS 60 --CUR_INTRODUCED_CLS 20 --train_set 't4_ft' --test_set 'test' --num_classes 81 \
