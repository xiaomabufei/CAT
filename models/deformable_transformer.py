...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 num_encoder_layers=6, num_local_decoder_layers=6, num_class_decoder_layers=6, dim_feedforward=1024, dropout=0.1,
        ...
        self.local_decoder = DeformableTransformerDecoder(decoder_layer, num_local_decoder_layers, return_intermediate_dec)
        self.class_decoder = DeformableTransformerDecoder(decoder_layer, num_class_decoder_layers,
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None):
        ...
        return local_hs, class_hs, init_reference_out, local_inter_references_out, memory
...
def build_deforamble_transformer(args):
    return DeformableTransformer(
        ...
        num_local_decoder_layers=args.local_dec_layers,
        num_class_decoder_layers=args.class_dec_layers,
